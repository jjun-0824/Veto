...
def main():
  ...
  # Training script
  cmd.append('train/ddp_veto.py')  # Assuming it's in a 'train' subdirectory
  ...
  arg_map = {
      ...
      'B_start': ('-B_start', kd_p['B_start']),
      'B_end': ('-B_end', kd_p['B_end']),
      'B_schedule': ('-B_schedule', kd_p['B_schedule']),
  }
